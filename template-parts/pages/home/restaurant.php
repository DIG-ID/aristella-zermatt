<section class="section-events overflow-hidden bg-beige pt-14 pb-24">
    ...
    <div class="ar-container-grid !gap-0">
        ...
        <div class="col-span-1 md:col-span-8 xl:col-span-6 py-5 px-10 bg__restaurant flex flex-col justify-between">
            ...
            <div class="text__bar pb-2">
                ...
                <p class="text-body text-beige mt-16"><?php esc_html_e( 'Tischreservation: ', 'aristella' ) ?><?php the_field( 'restaurant_phone_number' ); ?></p>
            </div>
        </div>
    </div>
</section>