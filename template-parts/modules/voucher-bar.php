<section class="section-voucher bg-black py-6 z-30 relative">
	<div class="grid grid-cols-1 md:grid-cols-5 xl:grid-cols-5 items-start">
		...
		<div class="col-span-1 relative grid lg:block">
			<a class="text-3xl uppercase text-beige text-center order-2 lg:order-1 -mt-5 lg:mt-0" href="/vouchershop/" target="_blank">
			...
			<a class="text-sm uppercase text-beige text-center block bg-no-repeat relative lg:absolute lg:top-[-3.3rem] left-1/2 -translate-x-1/2 w-[180px] h-[80px] order-1 lg:order-2" href="/vouchershop/" target="_blank">
